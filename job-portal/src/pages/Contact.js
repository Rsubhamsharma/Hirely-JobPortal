                        ...
                        <div className="space-y-8">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:support@jobportal.com" className="text-blue-600 hover:text-blue-700">
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-slate-600">123 Tech Park, Innovation City,<br />Mumbai, India - 400001</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-8">
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <a href="#" className="w-12 h-12 bg-sky-100 rounded-lg flex items-center justify-center hover:bg-sky-200 transition-colors">
